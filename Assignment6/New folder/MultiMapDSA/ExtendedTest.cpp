...
void testCreate() {
	...
	IteratorMultiMap im = m.iterator();
...
void testRemove() {
	...
	v = m.search(0);
	assert(v.size() == 0);
	IteratorMultiMap it = m.iterator();
	it.next();
...
void testIterator() {
	...
	IteratorMultiMap im2 = m.iterator();
	...
	IteratorMultiMap im3 = m2.iterator();
	...
	IteratorMultiMap im4 = m3.iterator();
	...
	IteratorMultiMap im5 = m4.iterator();
	while (im5.valid()) {
