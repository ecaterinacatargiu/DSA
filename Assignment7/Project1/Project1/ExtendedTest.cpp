...
void testAllExtended() {
	testCreate();
	std::cout << "Done create" << endl;
	testAdd(relation2);
	std::cout << "Done add1" << endl;
	testAdd(relation3);
	std::cout << "Done add2" << endl;
	testRemove(relation2);
	std::cout << "Done remove1" << endl;
	testRemove(relation3);
	std::cout << "Done remove2" << endl;
	testQuantity(relation2);
	std::cout << "Done quantity1" << endl;
	testQuantity(relation3);
	std::cout << "Done qunatity2" << endl;
